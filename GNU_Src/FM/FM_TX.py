...
class FM_TX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.quad_rate = quad_rate = audio_rate*10
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/phu/repo/RadioShiftSDR/GNU_Src/FM/Tx/Conference.wav', True)
    ...
    def set_audio_rate(self, audio_rate):
        ...
        self.set_quad_rate(self.audio_rate*10)
